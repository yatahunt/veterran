...
// > todo: Повысить потребность в викингах когда есть незащищённые летающие юниты?
// > todo: Рабочие фигово избегают круг либератора. М.б. лучше их убирать подальше? (И увеличить радиус избегания)
// > todo: Линги закопанные на экспах. Теперь и минки! Но на них кидается скан. На лингов не кинуть, их вообще не видно
// > todo: ПВО в стиле Кетрока
// > todo: Починка юнитов проходящих мимо базы с рабочими (переделать нынешнюю починку)

// todo: Что-то сделать с летающими юнитами, баньши летят на смерть, отсупают дёрганно
// todo: Пехота иногда отсупает не отсреливаясь. Почему?
// todo: Рабочие едут чинить осаждённый ЦЦ и дохнут даже не доезжая до него
// todo: Да и просто рабочие переводятся на другой ЦЦ когда нет пути не простреливаемого танками
