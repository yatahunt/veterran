...
// todo: туррельки мешают быстрому майнингу
// todo: брать рабочих только с минералов, если можно
// todo: рипер раш
...
// todo: что-то в распределении рабочих поломано - катаются между cc, насыщают газ зо 4 (м.б. из-за выбора строителей)
// todo: перед постройкой проверять возможность через апи, и если нельзя, выбирать следующее место
